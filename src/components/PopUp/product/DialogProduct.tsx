...
export default function DialogProduct() {
    ...
    const handleViewDetail = () => {
        // convert id
        let strId: string  = JSON.stringify(item?._id)
                ...
                <DialogContentText>
                    <div className=' grid grid-cols-2 italic'>
                        ...
                        <div>
                            ...
                            {/* View Detail Button */}
                            <div onClick={handleViewDetail} className='lg:w-[150px] lg:h-10 items-center justify-center flex flex-row text-white bg-black hover:cursor-pointer hover:bg-slate-700'>
